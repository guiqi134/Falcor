...
def render_graph_realtime():
    ...
    # VBufferRT = createPass('VBufferRT', {'samplePattern': SamplePattern.Center, 'sampleCount': 16})
    # g.addPass(VBufferRT, 'VBufferRT')
    VBufferRaster = createPass('VBufferRaster', {'samplePattern': SamplePattern.Stratified, 'sampleCount': 16})
    ...
    g.addEdge('VBufferRaster.vbuffer', 'AreaLightReSTIR.vbuffer')
    g.addEdge('VBufferRaster.mvec', 'AreaLightReSTIR.motionVecs')
