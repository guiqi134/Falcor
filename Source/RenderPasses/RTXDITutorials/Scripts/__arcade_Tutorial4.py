...
def graph_ImportanceResampling():
    ...
    tracer.addPass(createPass("RTXDITutorial4", gResamplingParams), "RTXDI Tutorial 4")
    ...
    tracer.addEdge("VBuffer.vbuffer",         "RTXDI Tutorial 4.vbuffer")
    tracer.addEdge("VBuffer.mvec",            "RTXDI Tutorial 4.mvec")

    tracer.addEdge("RTXDI Tutorial 4.color", "Accumulation.input")
