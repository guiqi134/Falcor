...
def graph_ImportanceResampling():
    ...
    tracer.addPass(createPass("RTXDITutorial3", gResamplingParams), "RTXDI Tutorial 3")
    ...
    tracer.addEdge("VBuffer.vbuffer",         "RTXDI Tutorial 3.vbuffer")
    tracer.addEdge("VBuffer.mvec",            "RTXDI Tutorial 3.mvec")

    tracer.addEdge("RTXDI Tutorial 3.color", "Accumulation.input")
