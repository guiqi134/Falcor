...
def graph_ImportanceResampling():
    ...
    tracer.addEdge("VBuffer.vbuffer",         "RTXDI Tutorial 5.vbuffer")
    tracer.addEdge("VBuffer.mvec",            "RTXDI Tutorial 5.mvec")

    tracer.addEdge("RTXDI Tutorial 5.color", "Accumulation.input")
